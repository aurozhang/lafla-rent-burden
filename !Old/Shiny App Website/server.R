...
path   <- "C:/Users/iggyt/Desktop/LAFLA/Map Shiny App/Shiny App Website/"
mydata <- read_xlsx(paste0(path, "Merged LAFLA Data.xlsx"))
...
server <- function(input, output, session){
  ...
  # Set path
  Dir       <- "C:/Users/iggyt/Desktop/LAFLA"
  DirInput  <- "C:/Users/iggyt/Desktop/LAFLA/Input"
  DirOutput <- "C:/Users/iggyt/Desktop/LAFLA/Output"
  ...
  output$PL_chart <- renderPlotly({
    var_a = input$HM_map_a_val
    print(var_a)
    var_b = input$HM_map_b_val
    
    fig <- plot_ly(data = Var_AB(), x = ~var_a, y = ~var_b,
                   marker = list(size = 10,
